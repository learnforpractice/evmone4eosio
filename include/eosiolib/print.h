...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void prints_l( const char* cstr, uint32_t len);
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printi( int64_t value );
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printi128( const int128_t* value );
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printui128( const uint128_t* value );
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printsf(float value);
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printdf(double value);
...
*
    ...
    *  @endcode
    */
   WASM_IMPORT void printqf(const long double* value);
    ...
    * @endcode
    */
   WASM_IMPORT void printn( uint64_t name );

   /**
    */
   WASM_IMPORT void printhex( const void* data, uint32_t datalen );
