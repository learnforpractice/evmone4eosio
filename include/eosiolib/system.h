...
*
    ...
    */
   WASM_IMPORT void  eosio_assert( uint32_t test, const char* msg );
    ...
    */
   WASM_IMPORT void  eosio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   WASM_IMPORT void  eosio_assert_code( uint32_t test, uint64_t code );
...
//   [[noreturn]] void  eosio_exit( int32_t code );
    ...
    */
   WASM_IMPORT uint64_t  current_time(void);
