...
extern "C" {
  ...
  /**
    ...
    */
   WASM_IMPORT void get_resource_limits( account_name account, int64_t* ram_bytes, int64_t* net_weight, int64_t* cpu_weight );
    ...
    */
   WASM_IMPORT void set_resource_limits( account_name account, int64_t ram_bytes, int64_t net_weight, int64_t cpu_weight );
    ...
    */
   WASM_IMPORT void set_active_producers( char *producer_data, uint32_t producer_data_size );
   /**
    ...
    */
   WASM_IMPORT bool is_privileged( account_name account );
    ...
    */
   WASM_IMPORT void set_privileged( account_name account, bool is_priv );
    ...
    */
   WASM_IMPORT void set_blockchain_parameters_packed(char* data, uint32_t datalen);
    ...
    */
   WASM_IMPORT uint32_t get_blockchain_parameters_packed(char* data, uint32_t datalen);
    ...
    */
   WASM_IMPORT void activate_feature( int64_t f );
